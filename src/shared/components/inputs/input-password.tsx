...
export const InputPassword = ({ value, onChange, disabled, placeholder, label, error, helperText, helperLink, helperIcon }: Props) => {
    ...
    <label className="flex flex-col gap-[4px] text-xs">
      ...
      <div className="relative">
        <input
          ...
          className={clsx('border rounded h-[44px] px-[16px] pr-[40px] focus-visible:outline-none placeholder:text-neutral-600 w-full',
            disabled ? (
          ...
          {showPassword ? (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill={disabled ? Colors.neutral[700] : Colors.primary.primary}
              />
            </svg>
          ) : (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
