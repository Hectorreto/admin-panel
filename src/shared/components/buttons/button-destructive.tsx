    ...
    <button
      ...
      className={clsx(
        ...
        !disabled && !loading && [
          ...
          'border-alert-red hover:border-alert-red2 active:border-alert-red focus-visible:border-[#FFFFFF]',
          'focus-visible:outline-none focus-visible:shadow-[0_0_6px_4px_#96020080]',
        ],
        !disabled && loading && ['bg-alert-red text-neutral-00 border-alert-red'],
        disabled && [
